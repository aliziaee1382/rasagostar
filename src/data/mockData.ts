...
export const DEFAULT_PAGES_CONTENT: PagesContentData = {
  ...
  about: {
    ...
    headline: 'مجتمع صنعتی و قالب‌سازی رسا قطعه گستر مهر',
    subheadline: '«تجربه، تخصص و توانمندی در خدمت تولید»',
    ...
    historyParagraph1: 'کارخانه صنعتی رسا قطعه گستر مهر با بیش از ۴ دهه حضور مستمر و پیشگام در صنعت کشور، به عنوان یکی از مجموعه‌های برتر در زمینه طراحی و ساخت انواع قالب‌های صنعتی، خطوط پرسکاری ضربه‌ای و هیدرولیک تا ۴۰۰ تن، تزریق پلاستیک مهندسی و برش لیزر فایبر فعالیت می‌نماید.',
    historyParagraph2: 'تمرکز ما بر ایجاد یک زنجیره تامین یکپارچه و مطمئن از فاز ایده و نقشه اولیه تا تولید انبوه قطعات صنعتی، کاهش بهای تمام‌شده و تضمین ۱۰۰ درصدی کیفیت و دقت ابعادی است.',
    ...
    ethicsTitle: 'منشور اخلاقی و تعهدات بنیادین',
    ethicsSubtitle: 'سه رکن اساسی تعهد سازمانی در رسا قطعه گستر مهر',
    coreValues: [
      {
        icon: 'Target',
    ...
    qualityPolicyTitle: 'پایش مستمر، تجهیزات کالیبره و تضمین صفر درصد عدم‌انطباق',
    qualityPolicySubtitle: 'سیستم مدیریت کیفیت (Quality Control)',
    qualityPolicyText: 'واحد کنترل کیفیت (QC) کارخانه رسا قطعه گستر مهر به صورت مستقل و سیستماتیک، بر کلیه مراحل ورودی متریال، در حین تولید (IPQC) و بازرسی نهایی محصول نظارت دارد. تجهیزات اندازه‌گیری دقیق، فیکسچرهای کنترلی و فرآیند پایش دوره‌ای تضمین می‌کنند که قطعه تولیدی بدون کمترین خطا و با بالاترین سطح انطباق تحویل مشتری گردد.',
    ...
    ctaTitle: 'میزبان مدیران محترم فنی، زنجیره تامین و کارفرمایان صنعتی هستیم',
    ctaSubtitle: 'دعوت به بازدید حضوری از کارخانه',
    ctaDescription: 'جهت بررسی میدانی توانمندی‌های خطوط قالب‌سازی، پرسکاری سنگین، برش لیزر و تزریق پلاستیک و همچنین مذاکره فنی پروژه‌های تولیدی، از شما دعوت می‌کنیم تا با هماهنگی قبلی از سالن‌های کارخانه در شهرک صنعتی کارآفرینان جاجرود بازدید فرمایید.',
    ctaAddress: 'استان تهران، جاجرود، شهرک صنعتی کارآفرینان، خیابان اصلی، پلاک ۴',
